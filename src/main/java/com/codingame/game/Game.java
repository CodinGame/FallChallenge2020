...
public class Game {
                ...
                if (action.isSpell()) {
                    ...
                    if (optSpell.isPresent()) {
                        ...
                        if (spell instanceof TomeSpell) {
                            ...
                            doDelivery(player, (DeliverySpell) spell);
                            ...
                            gameSummaryManager.addPlayerDelivery(player, spell);
    ...
    private void doDelivery(Player p, DeliverySpell del) throws GameException {
        ...
        delivered.add(new DeliveryCompletion(del, deliveries.indexOf(del)));
        p.addDelivery();
