...
<div class="statement-body">
  ...
  <div class="statement-section statement-goal">
    ...
    <p style="margin-bottom: 10px">
      ...
      However, the <b>witch's hut</b> in witch they set up shop is quite small, so they must share the same workspace, and deal with
  ...
  <div class="statement-section statement-rules">
    ...
    color: #838891;
      ...
      <p>For instance, a client order with <const><var>delta</var> = -2, -1, 0, 0</const> means you have to consume 2
        tier-0 ingredients and 1 tier-2 ingredients from your inventory in order to brew the potion.</p>
